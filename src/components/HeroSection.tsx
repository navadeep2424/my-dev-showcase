      ...
      <div className="container relative z-10 px-6 pt-24">
        <div className="max-w-4xl">
          <motion.p
            ...
            className="font-display text-primary text-lg mb-4"
          >
            Hello, I'm
          </motion.p>
          ...
          >
            Full-stack web developer crafting fast, beautiful, and accessible
            digital experiences. Turning ideas into pixel-perfect reality.
          </motion.p>
          ...
          >
            <a
              href="#projects"
              className="inline-flex px-7 py-3.5 rounded-full bg-primary text-primary-foreground font-display font-medium hover:opacity-90 transition-opacity"
            >
              View My Work
            </a>
            <a
